...
public class SesionPraxiaGrabarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //miniatura = findViewById(R.id.imageMiniaturaVideo);

        /////////falta guardar el id del paciente y de la praxia
        paciente_id = "1";
        praxias_id = "1";
        Aprobado = "0";
        Fecha = "";
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode){
            case COD_VIDEO:
                ...
                request.put("paciente_id",paciente_id);
                request.put("praxias_id",praxias_id);
                request.put("Aprobado",Aprobado);
                request.put("Fecha",Fecha);
                request.put("ruta",ruta);

                apiClient.registroSesionPraxias(request).enqueue(new Callback<ResponseStatus>() {
                    @Override
